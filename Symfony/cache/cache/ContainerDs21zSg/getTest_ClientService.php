...
class getTest_ClientService extends App_KernelTestDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/browser-kit/AbstractBrowser.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-kernel/HttpKernelBrowser.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/framework-bundle/KernelBrowser.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/browser-kit/History.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/browser-kit/CookieJar.php';
