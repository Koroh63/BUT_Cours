...
class getSecurity_Listener_UserChecker_MainService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-http/EventListener/UserCheckerListener.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-core/User/UserCheckerInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-core/User/InMemoryUserChecker.php';
