...
class get_Messenger_HandlerDescriptor_VMw0m61Service extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/messenger/Handler/HandlerDescriptor.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/notifier/Messenger/MessageHandler.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/notifier/Transport/TransportInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/notifier/Transport/Transports.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/notifier/Transport.php';
