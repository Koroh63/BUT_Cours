...
class getConsole_Command_MessengerFailedMessagesRetryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/messenger/Command/AbstractFailedMessagesCommand.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/console/Command/SignalableCommandInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/messenger/Command/FailedMessagesRetryCommand.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/messenger/Transport/Serialization/SerializerInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/messenger/Transport/Serialization/PhpSerializer.php';
