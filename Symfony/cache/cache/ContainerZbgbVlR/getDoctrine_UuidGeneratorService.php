...
class getDoctrine_UuidGeneratorService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/doctrine/orm/lib/Doctrine/ORM/Id/AbstractIdGenerator.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/doctrine-bridge/IdGenerator/UuidGenerator.php';
