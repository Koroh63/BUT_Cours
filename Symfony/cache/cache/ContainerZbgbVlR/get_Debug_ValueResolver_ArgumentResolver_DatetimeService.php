...
class get_Debug_ValueResolver_ArgumentResolver_DatetimeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-kernel/Controller/ArgumentResolver/TraceableValueResolver.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-kernel/Controller/ArgumentResolver/DateTimeValueResolver.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/psr/clock/src/ClockInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/clock/ClockInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/clock/Clock.php';
