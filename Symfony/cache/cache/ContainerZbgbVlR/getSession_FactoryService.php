...
class getSession_FactoryService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/Session/SessionFactoryInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/Session/SessionFactory.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/Session/Storage/SessionStorageFactoryInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/Session/Storage/NativeSessionStorageFactory.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/Session/SessionBagInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/Session/Storage/MetadataBag.php';
