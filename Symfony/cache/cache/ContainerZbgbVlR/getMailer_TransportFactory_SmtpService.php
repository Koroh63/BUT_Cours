...
class getMailer_TransportFactory_SmtpService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/mailer/Transport/TransportFactoryInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/mailer/Transport/AbstractTransportFactory.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/mailer/Transport/Smtp/EsmtpTransportFactory.php';
