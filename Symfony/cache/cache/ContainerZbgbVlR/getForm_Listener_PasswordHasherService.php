...
class getForm_Listener_PasswordHasherService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/form/Extension/PasswordHasher/EventListener/PasswordHasherListener.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/password-hasher/Hasher/UserPasswordHasherInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/password-hasher/Hasher/UserPasswordHasher.php';
