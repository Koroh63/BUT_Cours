...
class get_Messenger_HandlerDescriptor_KEzMhfsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/console/Messenger/RunCommandMessageHandler.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/console/Application.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/framework-bundle/Console/Application.php';
