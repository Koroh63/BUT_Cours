...
class getNotifier_TransportFactory_NullService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/notifier/Transport/TransportFactoryInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/notifier/Transport/AbstractTransportFactory.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/notifier/Transport/NullTransportFactory.php';
