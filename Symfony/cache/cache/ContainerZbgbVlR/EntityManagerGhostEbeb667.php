...
namespace ContainerZbgbVlR;
include_once \dirname(__DIR__, 3).'/TP1/vendor/doctrine/persistence/src/Persistence/ObjectManager.php';
include_once \dirname(__DIR__, 3).'/TP1/vendor/doctrine/orm/lib/Doctrine/ORM/EntityManagerInterface.php';
include_once \dirname(__DIR__, 3).'/TP1/vendor/doctrine/orm/lib/Doctrine/ORM/EntityManager.php';
