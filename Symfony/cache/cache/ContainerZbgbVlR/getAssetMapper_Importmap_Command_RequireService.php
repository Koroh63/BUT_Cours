...
class getAssetMapper_Importmap_Command_RequireService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/asset-mapper/Command/VersionProblemCommandTrait.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/asset-mapper/Command/ImportMapRequireCommand.php';
