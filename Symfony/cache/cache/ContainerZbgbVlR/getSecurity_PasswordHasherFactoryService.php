...
class getSecurity_PasswordHasherFactoryService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/password-hasher/Hasher/PasswordHasherFactoryInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/password-hasher/Hasher/PasswordHasherFactory.php';
