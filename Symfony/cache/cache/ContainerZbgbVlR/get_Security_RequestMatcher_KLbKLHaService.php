...
class get_Security_RequestMatcher_KLbKLHaService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/RequestMatcherInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/ChainRequestMatcher.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-foundation/RequestMatcher/PathRequestMatcher.php';
