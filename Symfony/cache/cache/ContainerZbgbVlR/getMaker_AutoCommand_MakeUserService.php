...
class getMaker_AutoCommand_MakeUserService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/maker-bundle/src/Maker/MakeUser.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/maker-bundle/src/Security/UserClassBuilder.php';
