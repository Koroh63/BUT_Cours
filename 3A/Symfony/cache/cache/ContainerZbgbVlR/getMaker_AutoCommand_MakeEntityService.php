...
class getMaker_AutoCommand_MakeEntityService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/maker-bundle/src/InputAwareMakerInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/maker-bundle/src/Maker/MakeEntity.php';
