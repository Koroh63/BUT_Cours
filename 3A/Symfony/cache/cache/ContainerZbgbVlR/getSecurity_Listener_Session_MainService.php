...
class getSecurity_Listener_Session_MainService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-http/EventListener/SessionStrategyListener.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-http/Session/SessionAuthenticationStrategyInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-http/Session/SessionAuthenticationStrategy.php';
