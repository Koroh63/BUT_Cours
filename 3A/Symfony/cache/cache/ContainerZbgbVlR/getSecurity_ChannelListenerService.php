...
class getSecurity_ChannelListenerService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-http/Firewall/ChannelListener.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-http/AccessMapInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/security-http/AccessMap.php';
