...
class getConsole_Command_YamlLintService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/yaml/Command/LintCommand.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/framework-bundle/Command/YamlLintCommand.php';
