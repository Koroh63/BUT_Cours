...
class getTwig_Form_RendererService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/form/FormRendererInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/form/FormRenderer.php';
