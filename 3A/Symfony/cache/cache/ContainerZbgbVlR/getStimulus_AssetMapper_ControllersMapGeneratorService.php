...
class getStimulus_AssetMapper_ControllersMapGeneratorService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/stimulus-bundle/src/AssetMapper/ControllersMapGenerator.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/stimulus-bundle/src/AssetMapper/AutoImportLocator.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/stimulus-bundle/src/Ux/UxPackageReader.php';
        ...
        return $container->privates['stimulus.asset_mapper.controllers_map_generator'] = new \Symfony\UX\StimulusBundle\AssetMapper\ControllersMapGenerator($a, ($container->privates['stimulus.asset_mapper.ux_package_reader'] ??= new \Symfony\UX\StimulusBundle\Ux\UxPackageReader((\dirname(__DIR__, 3).'/TP1'))), [(\dirname(__DIR__, 3).'/TP1/assets/controllers')], (\dirname(__DIR__, 3).'/TP1/assets/controllers.json'), new \Symfony\UX\StimulusBundle\AssetMapper\AutoImportLocator(($container->privates['asset_mapper.importmap.config_reader'] ?? $container->load('getAssetMapper_Importmap_ConfigReaderService')), $a));
    }
}
