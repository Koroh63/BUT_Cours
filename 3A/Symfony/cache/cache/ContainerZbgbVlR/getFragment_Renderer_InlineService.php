...
class getFragment_Renderer_InlineService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-kernel/Fragment/FragmentRendererInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-kernel/Fragment/RoutableFragmentRenderer.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/http-kernel/Fragment/InlineFragmentRenderer.php';
