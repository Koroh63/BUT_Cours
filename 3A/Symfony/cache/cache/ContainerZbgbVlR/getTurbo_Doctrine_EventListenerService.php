...
class getTurbo_Doctrine_EventListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/ux-turbo/src/Broadcaster/ImuxBroadcaster.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/ux-turbo/src/Broadcaster/IdAccessor.php';
