...
class getVarDumper_Command_ServerDumpService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/var-dumper/Command/ServerDumpCommand.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/var-dumper/Server/DumpServer.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/var-dumper/Command/Descriptor/DumpDescriptorInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/var-dumper/Command/Descriptor/CliDescriptor.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/var-dumper/Command/Descriptor/HtmlDescriptor.php';
