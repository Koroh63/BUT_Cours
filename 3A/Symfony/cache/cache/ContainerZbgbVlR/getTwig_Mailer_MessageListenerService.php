...
class getTwig_Mailer_MessageListenerService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/mailer/EventListener/MessageListener.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/mime/BodyRendererInterface.php';
        include_once \dirname(__DIR__, 3).'/TP1/vendor/symfony/twig-bridge/Mime/BodyRenderer.php';
